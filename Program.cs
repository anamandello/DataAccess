...
static void GetCategory(SqlConnection connection){
  var category = connection.QueryFirstOrDefault<Category>("SELECT TOP 1 [Id], [Title] FROM [Category] WHERE [Id]=@id", new {id = "af3407aa-11ae-4621-a2ef-2028b85507c4"});
...
static void CreateCategory(SqlConnection connection){
  ...
  category.Url = "categoria-nova";
  category.Description = "Categoria destinada a serviços";
  category.Order = 8;
  category.Summary = "Nova";
...
static void DeleteCategory(SqlConnection connection){
  ...
  var rows = connection.Execute(deleteQuery, new { id = new Guid("81e68cca-d183-4386-bb73-b11bc1edac7c") });
...
static void CreateManyCategory(SqlConnection connection){
  var category = new Category();
  category.Id = Guid.NewGuid();
  category.Title = "Categoria Nova";
  category.Url = "categoria-nova";
  category.Description = "Categoria nova destinada a serviços";
  category.Order = 9;
  category.Summary = "Categoria nova";
  category.Featured = false;

  var category2 = new Category();
  category2.Id = Guid.NewGuid();
  category2.Title = "Categoria Nova 2";
  category2.Url = "categoria-nova2";
  category2.Description = "Categoria nova2 destinada a serviços";
  category2.Order = 10;
  category2.Summary = "Categoria nova2";
  category2.Featured = true;

  var insertSql = @"INSERT INTO [Category] VALUES (@Id, @Title, @Url, @Summary, @Order, @Description, @Featured)";
  var rows = connection.Execute(insertSql, new []{
    new{ category.Id, category.Title, category.Url, category.Summary, category.Order, category.Description, category.Featured}, 
...
static void ExecuteProcedure(SqlConnection connection){
  ...
  var pars = new { StudentId="5c53eacd-74e2-4462-834d-93f23018a957"};
...
static void ExecuteScalar(SqlConnection connection){
  ...
  Console.WriteLine($"A categoria inserido foi: {id}");
}
